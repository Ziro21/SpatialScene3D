...
DRIVE_FRAMES = f"./drive/MyDrive/scene3d/{SCENE_NAME}/frames"

# Working directories on Colab (local SSD = much faster I/O than Drive)
WORK_DIR = f"./scene3d_work/{SCENE_NAME}"
FRAMES_DIR = f"{WORK_DIR}/frames"
SLAM_DIR = "./MASt3R-SLAM"
...
DRIVE_OUTPUT = f"./drive/MyDrive/scene3d/{SCENE_NAME}/outputs"
